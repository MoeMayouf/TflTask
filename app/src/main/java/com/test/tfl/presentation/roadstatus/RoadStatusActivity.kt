...
import com.test.tfl.common.dagger.activity.ActivityComponent
import com.test.tfl.common.dagger.activity.ActivityComponentHolder
import com.test.tfl.common.dagger.activity.DaggerActivityComponent
...
class RoadStatusActivity : AppCompatActivity(), RoadStatusPresenter.RoadView,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCheckStatus.setOnClickListener { roadStatusPresenter.getRoadStatus(etRoadName.text.toString()) }
    }
    ...
    override fun showRoadStatus(roadModel: List<RoadModel>) {
        ...
        tvDisplayName.text = String.format(getString(R.string.road) + roadModel[0].displayName)
        tvDisplaySeverity.text =
            String.format(getString(R.string.severity) + roadModel[0].statusSeverity)
        tvSeverityDescr.text =
            String.format(getString(R.string.severity_description) + roadModel[0].statusSeverityDescription)
